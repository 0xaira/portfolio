...
import { FaBlog, FaSquareXTwitter } from "react-icons/fa6";
...
export default function Intro() {
  ...
  return (
    ...
    >
      ...
      >
        <span className="font-bold">Hello, I&apos;m Aira.</span> I&apos;m a{" "}
        <span className="font-bold">full-stack developer</span> with{" "}
        <span className="font-bold">2 years</span> of experience. I enjoy
        building <span className="italic">sites & webapps</span>. My focus is{" "}
        <br></br>
        <span className="underline">Next.js & Node.js</span>.
      </motion.h1>
      ...
      >
        ...
        <a
          className="group bg-white px-7 py-3 flex items-center gap-2 rounded-full outline-none focus:scale-110 hover:scale-110 active:scale-105 transition cursor-pointer borderBlac"
          href="/CV.pdf"
          download
        >
          Download CV{" "}
